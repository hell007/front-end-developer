...
>MYSQL
	...
	CREATE TABLE T_PERSON(
		FNAME VARCHAR(20) NOT NULL PRIMARY KEY(FNAME),
		FAGE INT,
		FREMARK VARCHAR(20)
	)
	
	CREATE TABLE T_DEBT(
		FNUMBER VARCHAR(20) PRIMARY KEY(FNUMBER),
...
>Oracle
	...
	CREATE TABLE T_PERSON(
		FNAME VARCHAR2(20) NOT NULL PRIMARY KEY(FNAME),
		FAGE NUMBER(10),
		FREMARK VARCHAR2(20)
	)
	
	CREATE TABLE T_DEBT(
		FNUMBER VARCHAR2(20) PRIMARY KEY(FNUMBER),
